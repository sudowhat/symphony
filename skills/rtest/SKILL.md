...
The term "rtest" is used consistently across all projects. The exact command to run it is project-specific and lives in `<project-folder>/SKILL.md` (e.g., `rtest.bat` for WhatDate).
