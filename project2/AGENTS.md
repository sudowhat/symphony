...
This project uses the **Symphony Protocol**, content lifecycle. Any agent, any vendor, starts the same way:

```
init project2 <role>   # composer | critic | designer | tester | implementer | srtl | orchestrator
```
